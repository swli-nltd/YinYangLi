...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        // 时间转轮 自定义控件
        final LinearLayout timePickerView = (LinearLayout) findViewById(R.id.timepicker);
        timePickerView.setBackgroundColor(mPickerOptions.bgColorWheel);

        initWheelTime(timePickerView);

        final SwitchButton changeMode = (SwitchButton) findViewById(R.id.change_toggle);
        changeMode.setOnCheckedChangeListener(new SwitchButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(SwitchButton view, boolean isChecked) {
                mPickerOptions.isLunarCalendar = isChecked;
                initWheelTime(timePickerView);
            }
        });
    }
