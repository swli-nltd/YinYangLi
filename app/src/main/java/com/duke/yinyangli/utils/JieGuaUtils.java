...
public class JieGuaUtils {
    ...
    public interface OnLoadListener {
        void onLoad(String json, JieGuaItem jieGuaItem);
    }
    ...
    public void getGuaJson(Context context, String name, OnLoadListener listener) {
        InputStream is = null;
        ByteArrayOutputStream bos = null;
        try {
            is = context.getAssets().open(name + ".json");
